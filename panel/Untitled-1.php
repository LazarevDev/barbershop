                        ...
                        while ($rowStaffList = mysqli_fetch_array($queryStaffList)) {
                            ...
                            <div class="staffFormCheck">
                                <?php for ($i=0; $i < $t; $i++) { 
                                    ...
                                    ?> 
                                    <label for="<?php echo $rowStaffList['login'].$i; ?>">
                                    <?php 
                                    ...
                                    <input type="checkbox" name="date[]" <?php  if($strip == $timestamp){ echo "checked"; } ?> id="<?php echo $rowStaffListLogin.$i; ?>"  value="<?php echo $timestamp."*".$rowStaffListLogin; ?>">
